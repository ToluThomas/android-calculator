...
public class CalculatorButton extends androidx.appcompat.widget.AppCompatButton {
    ...
    final Drawable defaultButtonBackground = ResourcesCompat.getDrawable(getResources(), android.R.drawable.btn_default,
            null);
    ...
    public CalculatorButton(@NonNull Context context, String buttonName, Drawable background, int index,
        ...
        this.button.setBackground(background == null ? defaultButtonBackground : background); // Give button some
                                                                                              // background
        this.button.setId(index); // Set the ID for each button
        this.button.setLayoutParams(layoutParams == null ? defaultLayoutParams : layoutParams); // Set width and height
                                                                                                // of button
    }
